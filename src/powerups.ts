...
export const POWERUP_DEFINITIONS: Record<PowerupId, PowerupDefinition> = {
    "single-letter-sprout": {
        ...
        shortLabel: "Hint",
        description: "Highlights the first letter of a target word",
        cost: 50,
    ...
    "lumina-cyclone": {
        ...
        shortLabel: "Shuffle",
        description: "Mixes the board while keeping your progress",
        cost: 100,
    ...
    "super-root": {
        ...
        description: "Reveals and solves one target word",
        cost: 250,
    ...
    "bioluminescent-compass": {
        ...
        shortLabel: "Compass",
        description: "Points toward the next word",
        cost: 350,
    ...
    "flora-spectrometer": {
        ...
        description: "Highlights the starting cell of every unfound word",
        cost: 500,
    ...
    "nitrogen-booster": {
        ...
        description: "Doubles your seed rewards for this level",
        cost: 600,
