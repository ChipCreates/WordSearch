...
// Bumped to 5 for WSP-2.5: bloomedRarityTiers changed shape (a raw number ->
// bloomedRarityTierIds, a string[] of distinct tiers actually bloomed), and
// achievement ids can now be migrated on load (see ACHIEVEMENT_ID_MIGRATIONS).
// Neither change is branched on this version number directly -- normalizeSaveData
// detects the old numeric shape structurally -- but the bump documents that a
// save's exact shape changed here, consistent with how this field is used
