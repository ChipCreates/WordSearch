...
export default function SuccessScreen({ category, level, seeds, targetWordCount, baseSeeds, bonusWords, bonusSeeds, promotion, promotionAvatarBackgroundPosition = "0% 0%", onDismissPromotion = () => {}, onNextLevel, onRestart }: Props) {
    ...
    return (
        <div className="ws-success-overlay">
            ...
            <p style={{ margin: "10px 0 0", fontFamily: "var(--font-headline)", fontSize: "1.2rem", fontWeight: 800, color: "var(--color-primary)", textShadow: "0 0 10px rgba(0,228,121,0.3)" }}>
                +{baseSeeds + bonusSeeds} SEEDS EARNED!
            </p>
            ...
            <div aria-label="Level completion summary" style={{ marginTop: 12, padding: "10px 14px", borderRadius: 12, background: "rgba(236, 177, 255, 0.14)", border: "1px solid rgba(236, 177, 255, 0.35)", color: "var(--color-secondary)", textAlign: "left" }}>
                <div style={{ fontSize: "0.85rem" }}>Target words found: {targetWordCount}</div>
                ...
                <div style={{ fontSize: "0.8rem", marginTop: 8, borderTop: "1px solid rgba(236, 177, 255, 0.3)", paddingTop: 6 }}>
                    <div>Base reward: +{baseSeeds} Seeds</div>
                    <div>Bonus reward: +{bonusSeeds} Seeds</div>
                    <div style={{ fontWeight: 700, marginTop: 2 }}>Total: +{baseSeeds + bonusSeeds} Seeds</div>
                </div>
            </div>
